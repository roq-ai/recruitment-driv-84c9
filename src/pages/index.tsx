  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of hiring with Recruitment Drive, your ultimate solution for a seamless and efficient testing recruitment process."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1521791136064-7986c2920216?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZWNydWl0bWVudHxlbnwwfHx8fDE2ODk4NzYyMzN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of hiring with Recruitment Drive, your ultimate solution for a seamless and efficient testing recruitment process.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                ...
                <Card userTypeName="Job Applicant" type="job-applicant" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
